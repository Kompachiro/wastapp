...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = new \Symfony\Component\Mercure\Jwt\LcobucciFactory($container->getEnv('MERCURE_JWT_SECRET'), 'hmac.sha256', NULL, '');

        $f = new \Symfony\Component\Mercure\Debug\TraceableHub(new \Symfony\Component\Mercure\Hub($container->getEnv('MERCURE_URL'), new \Symfony\Component\Mercure\Jwt\FactoryTokenProvider($e, [], [0 => '*']), $e, $container->getEnv('MERCURE_PUBLIC_URL'), ($container->privates['http_client'] ?? $container->load('getHttpClientService'))), $d);

        $g = new \Symfony\Component\Mercure\HubRegistry($f, ['default' => $f]);
        ...
        $instance->addExtension(new \Symfony\Component\Mercure\Twig\MercureExtension($g, new \Symfony\Component\Mercure\Authorization($g, NULL), $b));
